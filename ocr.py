...
def perform_ocr(image_folder, csv_file):
    ...
    if easyocr is not None:
        try:
            ...
            engine = 'easyocr'
            print("ℹ️ Using easyocr for text extraction.")
    ...
    for new_index, row in tqdm(df.iterrows(), total=len(df), desc="Renaming"):
...
def main():
    ...
    default_images = os.path.join(base_dir, "reddit_memes_dataset", "memes")
    default_csv = os.path.join(base_dir, "reddit_memes_dataset", "data.csv")
